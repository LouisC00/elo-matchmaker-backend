...
export namespace Prisma {
  ...
  */
  ...
  export type DeveloperOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "password" | "apiKey" | "createdAt", ExtArgs["result"]["developer"]>
  ...
  interface DeveloperFieldRefs {
    ...
    readonly apiKey: FieldRef<"Developer", 'String'>
  ...
  export type DeveloperWhereInput = {
    ...
    apiKey?: StringFilter<"Developer"> | string
  ...
  export type DeveloperScalarWhereWithAggregatesInput = {
    ...
    apiKey?: StringWithAggregatesFilter<"Developer"> | string
